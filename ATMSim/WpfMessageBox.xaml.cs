...
namespace ATMSim
{
    ...
    public partial class WpfMessageBox : Window
    {
        ...
        public static MessageBoxResult Show(string caption, string text, MessageBoxButton button, MessageBoxImage image, MessageBoxType type)
        {
            _messageBox = new WpfMessageBox { txtMsg = { Text = text }, MessageTitle = { Text = caption } };
        ...
        private static void SetTitleBarColor(MessageBoxType type)
        {
            ...
            switch (type)
            {
                case MessageBoxType.Error:
                    {
                        solidColor.Color = Color.FromRgb(183, 0, 0);
                        _messageBox.TitleBar.Fill = solidColor;
                        break;
                    }
                    
                case MessageBoxType.Warning:
                    {
                        solidColor.Color = Color.FromRgb(204, 118, 0);
                        _messageBox.TitleBar.Fill = solidColor;
                        break;
                    }
            }
